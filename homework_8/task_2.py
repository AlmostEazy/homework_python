"""Задание 2. Реализовать программу работы с органическими клетками,
состоящими из ячеек.
...
увеличение,уменьшение, умножение и целочисленное
...
принимающий экземпляр класса и количество ячеек в ряду. Данный метод
...
class Cell:
    ...
    def __add__(self, other):
        return f"Размер клетки после объединения: " \
               f"{self.quantity + other.quantity}"

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f"Размер клетки после уменьшения: " \
               f"{sub}" if sub > 0 else "Клетка растворилась"

    def __truediv__(self, other):
        return f"Размер клетки после деления: " \
               f"{self.quantity // other.quantity}"

    def __mul__(self, other):
        return f"Размер клетки после слияния: " \
               f"{self.quantity * other.quantity}"
...
cell_1 = Cell(18)
cell_2 = Cell(6)
print(f"Начальный размер клеток: {cell_1} и {cell_2}")
print(cell_1 + cell_2)
print(cell_1 - cell_2)
print(cell_1 / cell_2)
print(cell_1 * cell_2)
